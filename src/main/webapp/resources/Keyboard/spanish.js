...
jQuery.keyboard.layouts['spanish-email'] = {
	'name' : 'spanish-email',
	'lang' : ['es'],
	'normal' : [
		"1 2 3 4 5 6 7 8 9 0 \u00bf {bksp}",
...
jQuery.keyboard.layouts['spanish-qwerty-min'] = {
		'name' : 'spanish-qwerty-min',
		'lang' : ['es'],
		'normal' : [
			"1 2 3 4 5 6 7 8 9 0 \u00a1 {bksp}",
			"Q W E R T Y U I O P",
...
jQuery.keyboard.layouts['only-numbers'] = {
		'name' : 'only-numbers',
		'lang' : ['es'],
		'normal' : [
			" {b} ",
...
jQuery.keyboard.layouts['colombian-address'] = {
		'name' : 'only-numbers',
		'lang' : ['es'],
		'normal' : [			
			"1 2 3 4 5 6 7 8 9 0 {b}",
			"CL CARR KM TO AP # - DG AV",
			"CA TV BIS VDA SUR",
